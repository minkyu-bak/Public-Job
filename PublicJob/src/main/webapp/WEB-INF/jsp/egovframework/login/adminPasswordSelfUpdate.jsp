...
<script type="text/javascript">
	$(document).ready(function() {
			 ...
			 if (!sendIt()) {
				 return false;
					...
					if (confirm("비밀번호를 변경하시겠습니까?")) {
						document.adminInfoForm.action = "admin_AdminPasswordSelfUpdate";
		...
		$("#btnBack").click(function() {
			document.adminInfoForm.action = "admin_MyPage";
	...
	<section id="container">
		...
		<input type="hidden" id="adminId" name="adminId" value="${AdminInfo.adminId}">
			...
			<colgroup>
				...
				<td><input type="password" style="text-align: left;" id="adminPassword" name="adminPassword"></td>
				</tr>
				<tr>
				<td><label for="formGroupExampleInput2">변경할 비밀번호</label></td>
				<td><input type="password" style="text-align: left;" id="adminPasswordUpdate" name="adminPasswordUpdate"></td>
				</tr>
				<tr>
				<td><label for="formGroupExampleInput2">변경할 비밀번호 확인</label></td>
				<td><input  type="password" style="text-align: left;" id="adminPasswordUpdateCheck" name="adminPasswordUpdateCheck"></td>
				</tr>
				
			</table>
			<div>
				<button type="submit" id="btnBack" class="btn btn-primary btn-md"  style="float: left;">이전으로</button>
				<button type="submit" id="btnAdminPasswordUpdate" class="btn btn-primary" style="float:right;">변경하기</button>
			</div>
		</form>
	</section>
	<hr />
