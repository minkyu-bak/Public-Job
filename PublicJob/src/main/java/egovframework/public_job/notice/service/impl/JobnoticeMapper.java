...
public interface JobnoticeMapper {
	 ...
	 * @exception Exception
	 */
	public void jobNoticeCreate(JobnoticeVO jobnoticeVO) throws Exception;
	 ...
	 * @exception Exception
	 */
	public void jobFileInsert(Map<String, Object> map) throws Exception;
	...
	/**
	 * 관리자_공공일자리 공고의 파일 삭제 요청 시 정보를 변경한다.(실제파일은 삭제되지 않으며, DEL_GB에 의해 조회 되지 않음)
	 * 
	 * @param Map
	 * @return Map형
	 * @exception Exception
	 */
	public void jobFileUpdate(Map<String, Object> map) throws Exception;
	
	/**
	 * 관리자_공공일자리 공고의 파일을 업데이트한다.
	 * 
	 * @param vo - 업데이트할 정보가 담긴 FileVO
	 * @return void형
	 * @exception Exception
	 */
	public void noticeUpdate(JobnoticeVO jobnoticeVO) throws Exception;
